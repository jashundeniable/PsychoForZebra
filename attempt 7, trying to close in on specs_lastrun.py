...
expName = 'attempt 7, trying to close in on specs'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jash/Desktop/(pseudo_academ-/Ashoka/Neuro whatever/Larvae video creation/PsychoPy - files/attempt 7, trying to close in on specs_lastrun.py',
...
dots = visual.DotStim(
    ...
    fieldPos=(0.0, 0.0), fieldSize=1.0, fieldAnchor='top-left', fieldShape='square',
