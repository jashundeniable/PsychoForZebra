...
expName = 'PsychoPy attempt 5'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jash/Desktop/PsychoPy attempt 5_lastrun.py',
...
dots = visual.DotStim(
    win=win, name='dots',
    nDots=100, dotSize=90.0,
    speed=0.1, dir=0.0, coherence=1.0,
    fieldPos=(0.0, 0.0), fieldSize=90.0, fieldAnchor='center', fieldShape='circle',
...
while continueRoutine and routineTimer.getTime() < 16.0:
    ...
    if dots.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
    ...
    if dots.status == STARTED:
        ...
        if tThisFlipGlobal > dots.tStartRefresh + 15-frameTolerance:
