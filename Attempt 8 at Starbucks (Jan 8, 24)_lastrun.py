...
expName = 'Attempt 8 at Starbucks (Jan 8, 24)'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jash/Desktop/(pseudo_academ-/Ashoka/Neuro whatever/Larvae video creation/PsychoPy - files/Attempt 8 at Starbucks (Jan 8, 24)_lastrun.py',
...
dots = visual.DotStim(
    ...
    nDots=3, dotSize=12.0,
    speed=25.0, dir=right, coherence=1.0,
    fieldPos=(0.0, 0.0), fieldSize=600.0, fieldAnchor='top-left', fieldShape='square',
    signalDots='same', noiseDots='direction',dotLife=30.0,
    color=[-1.0000, -1.0000, -1.0000], colorSpace='rgb', opacity=100.0,
    depth=0.0)
...
while continueRoutine and routineTimer.getTime() < 30.0:
    ...
    if dots.status == STARTED:
        ...
        if tThisFlipGlobal > dots.tStartRefresh + 30-frameTolerance:
