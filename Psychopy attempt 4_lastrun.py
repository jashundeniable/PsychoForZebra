...
expName = 'Psychopy attempt 4'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jash/Desktop/Psychopy attempt 4_lastrun.py',
...
dots = visual.DotStim(
    win=win, name='dots',
    nDots=3, dotSize=25.0,
    speed=0.1, dir=0.0, coherence=1.0,
    fieldPos=(0.0, 0.0), fieldSize=100.0, fieldAnchor='center', fieldShape='square',
