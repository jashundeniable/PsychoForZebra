...
expName = 'Psychopy attempt 1'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jash/Desktop/Psychopy attempt 1_lastrun.py',
...
dots = visual.DotStim(
    ...
    nDots=3, dotSize=0.05,
    speed=2.0, dir=1.0, coherence=1.0,
    fieldPos=(8.0, 9.0), fieldSize=1.0, fieldAnchor='bottom-left', fieldShape='square',
...
for thisTrial_2 in trials_2:
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() < 110.0:
            # get current time
            ...
            if dots.status == NOT_STARTED and tThisFlip >= 20.0-frameTolerance:
            ...
            if dots.status == STARTED:
                ...
                if tThisFlipGlobal > dots.tStartRefresh + 90.0-frameTolerance:
        ...
        if routineForceEnded:
            ...
            routineTimer.addTime(-110.000000)
        thisExp.nextEntry()
